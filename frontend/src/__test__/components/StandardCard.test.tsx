...
describe('StandardCard', () => {
    it('should render the component with correct title and description', () => {
        ...
        expect(screen.getByText('This test is for individuals entering data for timber licenses, whether creating new openings or updating existing ones.')).toBeInTheDocument();
    });
