...
import {Choice, Question, getRandomQuestions, calculateScorePercentage, isPassing, generateResultJson} from '../../utils/examCalculations';

const questions: Question[] = [
    {
        question: 'What isthe capital of France?',
        choices: [
